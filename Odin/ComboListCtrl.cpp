...
void CComboListCtrl::SetDblClickEvent(BOOL bState)
{
	m_bLbuttonDbl = bState;
}
		...
		if ((GetItemState(iRowIndex, flag ) & flag) == flag)
		{
			...
			if (GetWindowLong(m_hWnd, GWL_STYLE)/* & LVS_EDITLABELS*/)
			{
				...
				if (IsCombo(iColumnIndex))
				{
					...
					GetParent()->SendMessage(WM_SET_ITEMS, (WPARAM)(this), (LPARAM)&obComboItemsList);  
