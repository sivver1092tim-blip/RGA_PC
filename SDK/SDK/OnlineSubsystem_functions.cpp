...
void UOnlineSubsystem_TurnBasedMatchInterface::OnMatchReceivedTurn(const struct FString& Match, bool bDidBecomeActive)
{
	...
	UOnlineSubsystem_TurnBasedMatchInterface_OnMatchReceivedTurn_Params params;
	params.Match = Match;
...
void UOnlineSubsystem_TurnBasedMatchInterface::OnMatchEnded(const struct FString& Match)
{
	...
	UOnlineSubsystem_TurnBasedMatchInterface_OnMatchEnded_Params params;
	params.Match = Match;
