...
enum class FMovieSceneCapture_MovieSceneCapture_EHDRCaptureGamut : uint8_t
{
	HCGM_Rec709                    = 0,
	HCGM_P3DCI                     = 1,
	HCGM_Rec2020                   = 2,
...
enum class FMovieSceneCapture_MovieSceneCapture_EMovieSceneCaptureProtocolState : uint8_t
{
...
// 0x0010
struct FMovieSceneCapture_CompositionGraphCapturePasses
{
...
// 0x0008
struct FMovieSceneCapture_CaptureResolution
{
...
// 0x0070
struct FMovieSceneCapture_MovieSceneCaptureSettings
{
	struct FEngine_DirectoryPath                       OutputDirectory;                                          // 0x0000(0x0010) (Edit, BlueprintVisible, Config)
	...
	struct FMovieSceneCapture_CaptureResolution        Resolution;                                               // 0x0058(0x0008) (Edit, BlueprintVisible, Config)
...
// 0x0050
struct FMovieSceneCapture_CapturedPixelsID
{
...
// 0x0010
struct FMovieSceneCapture_CapturedPixels
{
...
// 0x0010
struct FMovieSceneCapture_FrameMetrics
{
