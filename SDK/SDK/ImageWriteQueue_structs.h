...
enum class FImageWriteQueue_ImageWriteQueue_EDesiredImageFormat : uint8_t
{
...
// 0x0060
struct FImageWriteQueue_ImageWriteOptions
{
	FImageWriteQueue_ImageWriteQueue_EDesiredImageFormat Format;                                                   // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
