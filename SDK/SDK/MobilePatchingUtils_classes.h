...
class UMobilePatchingUtils_MobileInstalledContent : public UObject
{
public:
...
class UMobilePatchingUtils_MobilePendingContent : public UMobilePatchingUtils_MobileInstalledContent
{
public:
...
class UMobilePatchingUtils_MobilePatchingLibrary : public UEngine_BlueprintFunctionLibrary
{
public:
	...
	class UMobilePatchingUtils_MobileInstalledContent* STATIC_GetInstalledContent(const struct FString& InstallDirectory);
