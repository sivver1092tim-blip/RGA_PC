...
enum class FGeometryCollectionCore_GeometryCollectionCore_EGeometryCollectionCacheType : uint8_t
{
...
// 0x006C
struct FGeometryCollectionCore_SolverCollisionData
{
...
// 0x0030
struct FGeometryCollectionCore_SolverBreakingData
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData)
...
// 0x00B8
struct FGeometryCollectionCore_RecordedFrame
{
	...
	TArray<struct FGeometryCollectionCore_SolverCollisionData> Collisions;                                               // 0x0040(0x0010) (ZeroConstructor)
	TArray<struct FGeometryCollectionCore_SolverBreakingData> Breakings;                                                // 0x0050(0x0010) (ZeroConstructor)
...
// 0x0010
struct FGeometryCollectionCore_RecordedTransformTrack
{
	TArray<struct FGeometryCollectionCore_RecordedFrame> Records;                                                  // 0x0000(0x0010) (ZeroConstructor)
};

// ScriptStruct GeometryCollectionCore.SolverTrailingData
// 0x0030
struct FGeometryCollectionCore_SolverTrailingData
{
	struct FVector                                     Location;                                                 // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     Velocity;                                                 // 0x000C(0x000C) (ZeroConstructor, IsPlainOldData)
	struct FVector                                     AngularVelocity;                                          // 0x0018(0x000C) (ZeroConstructor, IsPlainOldData)
