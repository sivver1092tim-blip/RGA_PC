...
enum class FAnimationCore_AnimationCore_ETransformConstraintType : uint8_t
{
...
enum class FAnimationCore_AnimationCore_EConstraintType : uint8_t
{
...
// 0x0080
struct FAnimationCore_CCDIKChainLink
{
...
// 0x0010
struct FAnimationCore_ConstraintDescriptor
{
	FAnimationCore_AnimationCore_EConstraintType       Type;                                                     // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0001(0x000F) MISSED OFFSET
};

// ScriptStruct AnimationCore.ConstraintData
// 0x0080
struct FAnimationCore_ConstraintData
{
	struct FAnimationCore_ConstraintDescriptor         Constraint;                                               // 0x0000(0x0010)
...
// 0x0003
struct FAnimationCore_FilterOptionPerAxis
{
...
// 0x0010
struct FAnimationCore_ConstraintDescriptionEx
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	struct FAnimationCore_FilterOptionPerAxis          AxesFilterOption;                                         // 0x0008(0x0003) (Edit)
	unsigned char                                      UnknownData01[0x5];                                       // 0x000B(0x0005) MISSED OFFSET
};

// ScriptStruct AnimationCore.AimConstraintDescription
// 0x0030 (0x0040 - 0x0010)
struct FAnimationCore_AimConstraintDescription : public FAnimationCore_ConstraintDescriptionEx
{
	struct FAnimationCore_Axis                         LookAt_Axis;                                              // 0x0010(0x0010) (Edit)
	struct FAnimationCore_Axis                         LookUp_Axis;                                              // 0x0020(0x0010) (Edit)
...
struct FAnimationCore_TransformConstraintDescription : public FAnimationCore_ConstraintDescriptionEx
{
	FAnimationCore_AnimationCore_ETransformConstraintType TransformType;                                            // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0011(0x0007) MISSED OFFSET
};

// ScriptStruct AnimationCore.ConstraintDescription
// 0x000D
struct FAnimationCore_ConstraintDescription
{
	...
	struct FAnimationCore_FilterOptionPerAxis          TranslationAxes;                                          // 0x0004(0x0003) (Edit, BlueprintVisible)
	struct FAnimationCore_FilterOptionPerAxis          RotationAxes;                                             // 0x0007(0x0003) (Edit, BlueprintVisible)
	struct FAnimationCore_FilterOptionPerAxis          ScaleAxes;                                                // 0x000A(0x0003) (Edit, BlueprintVisible)
};

// ScriptStruct AnimationCore.TransformConstraint
// 0x0028
struct FAnimationCore_TransformConstraint
{
	struct FAnimationCore_ConstraintDescription        Operator;                                                 // 0x0000(0x000D) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
...
// 0x0060
struct FAnimationCore_ConstraintOffset
{
...
// 0x0009
struct FAnimationCore_TransformFilter
{
	struct FAnimationCore_FilterOptionPerAxis          TranslationFilter;                                        // 0x0000(0x0003) (Edit, BlueprintVisible)
	struct FAnimationCore_FilterOptionPerAxis          RotationFilter;                                           // 0x0003(0x0003) (Edit, BlueprintVisible)
	struct FAnimationCore_FilterOptionPerAxis          ScaleFilter;                                              // 0x0006(0x0003) (Edit, BlueprintVisible)
};

// ScriptStruct AnimationCore.EulerTransform
// 0x0024
struct FAnimationCore_EulerTransform
{
...
// 0x0038
struct FAnimationCore_FABRIKChainLink
{
...
// 0x0010
struct FAnimationCore_NodeChain
{
...
// 0x0010
struct FAnimationCore_NodeObject
{
...
// 0x0070
struct FAnimationCore_NodeHierarchyData
{
	TArray<struct FAnimationCore_NodeObject>           Nodes;                                                    // 0x0000(0x0010) (ZeroConstructor)
...
// 0x0078
struct FAnimationCore_NodeHierarchyWithUserData
{
	unsigned char                                      UnknownData00[0x8];                                       // 0x0000(0x0008) MISSED OFFSET
	struct FAnimationCore_NodeHierarchyData            Hierarchy;                                                // 0x0008(0x0070)
};
