...
class UMagicLeapSecureStorage_MagicLeapSecureStorage : public UEngine_BlueprintFunctionLibrary
{
public:
	...
	bool STATIC_PutSecureSaveGame(const struct FString& Key, class UEngine_SaveGame* ObjectToStore);
	...
	bool STATIC_GetSecureSaveGame(const struct FString& Key, class UEngine_SaveGame** ObjectToRetrieve);
