...
// 0x0028
struct FLiveLinkMessageBusFramework_LiveLinkSubjectDataMessage
{
	struct FLiveLinkInterface_LiveLinkRefSkeleton      RefSkeleton;                                              // 0x0000(0x0020)
...
// 0x0008
struct FLiveLinkMessageBusFramework_LiveLinkClearSubject
{
...
// 0x0001
struct FLiveLinkMessageBusFramework_LiveLinkHeartbeatMessage
{
...
// 0x0004
struct FLiveLinkMessageBusFramework_LiveLinkConnectMessage
{
...
// 0x0040
struct FLiveLinkMessageBusFramework_LiveLinkPongMessage
{
...
// 0x0014
struct FLiveLinkMessageBusFramework_LiveLinkPingMessage
{
...
// 0x0090
struct FLiveLinkMessageBusFramework_LiveLinkSubjectFrameMessage
{
	struct FName                                       SubjectName;                                              // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<struct FTransform>                          Transforms;                                               // 0x0008(0x0010) (ZeroConstructor)
	TArray<struct FLiveLinkInterface_LiveLinkCurveElement> Curves;                                                   // 0x0018(0x0010) (ZeroConstructor)
	struct FLiveLinkInterface_LiveLinkMetaData         MetaData;                                                 // 0x0028(0x0060)
