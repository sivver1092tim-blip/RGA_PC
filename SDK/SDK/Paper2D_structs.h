...
enum class FPaper2D_Paper2D_EFlipbookCollisionMode : uint8_t
{
...
enum class FPaper2D_Paper2D_EPaperSpriteAtlasPadding : uint8_t
{
...
enum class FPaper2D_Paper2D_ETileMapProjectionMode : uint8_t
{
...
enum class FPaper2D_Paper2D_ESpritePivotMode : uint8_t
{
...
enum class FPaper2D_Paper2D_ESpritePolygonMode : uint8_t
{
...
enum class FPaper2D_Paper2D_ESpriteShapeType : uint8_t
{
...
enum class FPaper2D_Paper2D_ESpriteCollisionMode : uint8_t
{
...
// 0x0010
struct FPaper2D_PaperFlipbookKeyFrame
{
	class UPaper2D_PaperSprite*                        Sprite;                                                   // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0050
struct FPaper2D_SpriteInstanceData
{
	struct FMatrix                                     Transform;                                                // 0x0000(0x0040) (Edit, ZeroConstructor, IsPlainOldData)
	class UPaper2D_PaperSprite*                        SourceSprite;                                             // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0040
struct FPaper2D_PaperSpriteSocket
{
...
// 0x0038
struct FPaper2D_PaperTerrainMaterialRule
{
	class UPaper2D_PaperSprite*                        StartCap;                                                 // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	TArray<class UPaper2D_PaperSprite*>                Body;                                                     // 0x0008(0x0010) (Edit, ZeroConstructor)
	class UPaper2D_PaperSprite*                        EndCap;                                                   // 0x0018(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0010
struct FPaper2D_PaperTileInfo
{
	class UPaper2D_PaperTileSet*                       TileSet;                                                  // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0030
struct FPaper2D_SpriteGeometryShape
{
	FPaper2D_Paper2D_ESpriteShapeType                  ShapeType;                                                // 0x0000(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
// 0x0030
struct FPaper2D_SpriteGeometryCollection
{
	TArray<struct FPaper2D_SpriteGeometryShape>        Shapes;                                                   // 0x0000(0x0010) (Edit, ZeroConstructor)
	TEnumAsByte<FPaper2D_Paper2D_ESpritePolygonMode>   GeometryType;                                             // 0x0010(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0018
struct FPaper2D_PaperTileSetTerrain
{
...
// 0x0040
struct FPaper2D_PaperSpriteAtlasSlot
{
...
// 0x00D0
struct FPaper2D_SpriteDrawCallRecord
{
	struct FVector                                     Destination;                                              // 0x0000(0x000C) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	class UEngine_Texture*                             BaseTexture;                                              // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
...
// 0x0040
struct FPaper2D_SpriteAssetInitParameters
{
