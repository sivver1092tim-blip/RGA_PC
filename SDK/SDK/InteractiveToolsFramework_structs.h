...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EInputCaptureState : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EInputCaptureRequestType : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EInputCaptureSide : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EInputDevices : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_ETransformGizmoSubElements : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EToolSide : uint8_t
{
	EToolSide__Left                = 0,
	EToolSide__Mouse               = 1,
	EToolSide__Right               = 2,
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EToolMessageLevel : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_ESelectedObjectsModificationType : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EToolContextCoordinateSystem : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_EStandardToolContextMaterials : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_ESceneSnapQueryTargetType : uint8_t
{
...
enum class FInteractiveToolsFramework_InteractiveToolsFramework_ESceneSnapQueryType : uint8_t
{
...
// 0x0020
struct FInteractiveToolsFramework_BehaviorInfo
{
	class UInteractiveToolsFramework_InputBehavior*    Behavior;                                                 // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0008(0x0018) MISSED OFFSET
};

// ScriptStruct InteractiveToolsFramework.ActiveGizmo
// 0x0030
struct FInteractiveToolsFramework_ActiveGizmo
{
...
// 0x0008
struct FInteractiveToolsFramework_GizmoFloatParameterChange
{
...
// 0x0010
struct FInteractiveToolsFramework_GizmoVec2ParameterChange
{
...
// 0x0028
struct FInteractiveToolsFramework_InputRayHit
{
