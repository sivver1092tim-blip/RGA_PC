...
enum class FClothingSystemRuntimeNv_ClothingSystemRuntimeNv_EClothingWindMethod : uint8_t
{
...
enum class FClothingSystemRuntimeNv_ClothingSystemRuntimeNv_EMaskTarget_PhysMesh : uint8_t
{
...
// 0x0010
struct FClothingSystemRuntimeNv_ClothConstraintSetup
{
...
// 0x00D4
struct FClothingSystemRuntimeNv_ClothConfig
{
	FClothingSystemRuntimeNv_ClothingSystemRuntimeNv_EClothingWindMethod WindMethod;                                               // 0x0000(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	struct FClothingSystemRuntimeNv_ClothConstraintSetup VerticalConstraintConfig;                                 // 0x0004(0x0010) (Edit)
	struct FClothingSystemRuntimeNv_ClothConstraintSetup HorizontalConstraintConfig;                               // 0x0014(0x0010) (Edit)
	struct FClothingSystemRuntimeNv_ClothConstraintSetup BendConstraintConfig;                                     // 0x0024(0x0010) (Edit)
	struct FClothingSystemRuntimeNv_ClothConstraintSetup ShearConstraintConfig;                                    // 0x0034(0x0010) (Edit)
...
// 0x00A8
struct FClothingSystemRuntimeNv_ClothPhysicalMeshData
{
	...
	TArray<struct FClothingSystemRuntimeInterface_ClothVertBoneData> BoneData;                                                 // 0x0080(0x0010) (Edit, ZeroConstructor)
...
// 0x0108
struct FClothingSystemRuntimeNv_ClothLODData
{
	struct FClothingSystemRuntimeNv_ClothPhysicalMeshData PhysicalMeshData;                                         // 0x0000(0x00A8) (Edit)
	struct FClothingSystemRuntimeInterface_ClothCollisionData CollisionData;                                            // 0x00A8(0x0040) (Edit)
...
// 0x0030
struct FClothingSystemRuntimeNv_ClothParameterMask_PhysMesh
{
	struct FName                                       MaskName;                                                 // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
	FClothingSystemRuntimeNv_ClothingSystemRuntimeNv_EMaskTarget_PhysMesh CurrentTarget;                                            // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
