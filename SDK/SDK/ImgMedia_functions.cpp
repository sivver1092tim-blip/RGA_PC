...
void UImgMedia_ImgMediaSource::SetSequencePath(const struct FString& Path)
{
	...
	UImgMedia_ImgMediaSource_SetSequencePath_Params params;
	params.Path = Path;
...
struct FString UImgMedia_ImgMediaSource::GetSequencePath()
{
	...
	UImgMedia_ImgMediaSource_GetSequencePath_Params params;
...
void UImgMedia_ImgMediaSource::GetProxies(TArray<struct FString>* OutProxies)
{
	...
	UImgMedia_ImgMediaSource_GetProxies_Params params;
