...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EEmissionPatternTypeEnum : uint8_t
{
...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EInitialVelocityTypeEnum : uint8_t
{
...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EGeometryCollectionPhysicsTypeEnum : uint8_t
{
...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EImplicitTypeEnum : uint8_t
{
...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EObjectStateTypeEnum : uint8_t
{
...
enum class FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_ECollisionTypeEnum : uint8_t
{
