...
class UPaper2D_MaterialExpressionSpriteTextureSampler : public UEngine_MaterialExpressionTextureSampleParameter2D
{
public:
...
class APaper2D_PaperCharacter : public AEngine_Character
{
public:
...
class UPaper2D_PaperFlipbook : public UObject
{
public:
	float                                              FramesPerSecond;                                          // 0x0028(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x002C(0x0004) MISSED OFFSET
	TArray<struct FPaper2D_PaperFlipbookKeyFrame>      KeyFrames;                                                // 0x0030(0x0010) (Edit, ZeroConstructor)
	class UEngine_MaterialInterface*                   DefaultMaterial;                                          // 0x0040(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<FPaper2D_Paper2D_EFlipbookCollisionMode> CollisionSource;                                          // 0x0048(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	class UPaper2D_PaperSprite* GetSpriteAtTime(float Time, bool bClampToEnds);
	class UPaper2D_PaperSprite* GetSpriteAtFrame(int FrameIndex);
	int GetNumKeyFrames();
	int GetNumFrames();
...
class APaper2D_PaperFlipbookActor : public AEngine_Actor
{
public:
	class UPaper2D_PaperFlipbookComponent*             RenderComponent;                                          // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
class UPaper2D_PaperFlipbookComponent : public UEngine_MeshComponent
{
public:
	class UPaper2D_PaperFlipbook*                      SourceFlipbook;                                           // 0x0400(0x0008) (Edit, Net, ZeroConstructor, IsPlainOldData)
	class UEngine_MaterialInterface*                   Material;                                                 // 0x0408(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	class UEngine_BodySetup*                           CachedBodySetup;                                          // 0x0430(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	bool SetFlipbook(class UPaper2D_PaperFlipbook* NewFlipbook);
	void ReverseFromEnd();
	void Reverse();
	void PlayFromStart();
	void Play();
	void OnRep_SourceFlipbook(class UPaper2D_PaperFlipbook* OldFlipbook);
	bool IsReversing();
	bool IsPlaying();
	bool IsLooping();
	float GetPlayRate();
	...
	class UPaper2D_PaperFlipbook* GetFlipbook();
};


// Class Paper2D.PaperGroupedSpriteActor
// 0x0008 (0x0220 - 0x0218)
class APaper2D_PaperGroupedSpriteActor : public AEngine_Actor
{
public:
	class UPaper2D_PaperGroupedSpriteComponent*        RenderComponent;                                          // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
class UPaper2D_PaperGroupedSpriteComponent : public UEngine_MeshComponent
{
public:
	TArray<class UEngine_MaterialInterface*>           InstanceMaterials;                                        // 0x0400(0x0010) (ZeroConstructor)
	TArray<struct FPaper2D_SpriteInstanceData>         PerInstanceSpriteData;                                    // 0x0410(0x0010) (Edit, ZeroConstructor)
	...
	void ClearInstances();
	int AddInstance(const struct FTransform& Transform, class UPaper2D_PaperSprite* Sprite, bool bWorldSpace, const struct FLinearColor& Color);
};


// Class Paper2D.PaperRuntimeSettings
// 0x0008 (0x0030 - 0x0028)
class UPaper2D_PaperRuntimeSettings : public UObject
{
public:
...
class UPaper2D_PaperSprite : public UObject
{
public:
	unsigned char                                      UnknownData00[0x10];                                      // 0x0028(0x0010) MISSED OFFSET
	TArray<class UEngine_Texture*>                     AdditionalSourceTextures;                                 // 0x0038(0x0010) (Edit, ZeroConstructor)
	...
	class UEngine_Texture2D*                           BakedSourceTexture;                                       // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData)
	class UEngine_MaterialInterface*                   DefaultMaterial;                                          // 0x0060(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UEngine_MaterialInterface*                   AlternateMaterial;                                        // 0x0068(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<struct FPaper2D_PaperSpriteSocket>          Sockets;                                                  // 0x0070(0x0010) (Edit, ZeroConstructor)
	TEnumAsByte<FPaper2D_Paper2D_ESpriteCollisionMode> SpriteCollisionDomain;                                    // 0x0080(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UEngine_BodySetup*                           BodySetup;                                                // 0x0088(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
// 0x0008 (0x0220 - 0x0218)
class APaper2D_PaperSpriteActor : public AEngine_Actor
{
public:
	class UPaper2D_PaperSpriteComponent*               RenderComponent;                                          // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
class UPaper2D_PaperSpriteAtlas : public UObject
{
public:
...
// 0x0000 (0x0028 - 0x0028)
class UPaper2D_PaperSpriteBlueprintLibrary : public UEngine_BlueprintFunctionLibrary
{
public:
	...
	struct FSlateCore_SlateBrush STATIC_MakeBrushFromSprite(class UPaper2D_PaperSprite* Sprite, int Width, int Height);
};


// Class Paper2D.PaperSpriteComponent
// 0x0020 (0x0420 - 0x0400)
class UPaper2D_PaperSpriteComponent : public UEngine_MeshComponent
{
public:
	class UPaper2D_PaperSprite*                        SourceSprite;                                             // 0x0400(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UEngine_MaterialInterface*                   MaterialOverride;                                         // 0x0408(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	void SetSpriteColor(const struct FLinearColor& NewColor);
	bool SetSprite(class UPaper2D_PaperSprite* NewSprite);
	class UPaper2D_PaperSprite* GetSprite();
};


// Class Paper2D.PaperTerrainActor
// 0x0018 (0x0230 - 0x0218)
class APaper2D_PaperTerrainActor : public AEngine_Actor
{
public:
	class UEngine_SceneComponent*                      DummyRoot;                                                // 0x0218(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UPaper2D_PaperTerrainSplineComponent*        SplineComponent;                                          // 0x0220(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UPaper2D_PaperTerrainComponent*              RenderComponent;                                          // 0x0228(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
class UPaper2D_PaperTerrainComponent : public UEngine_PrimitiveComponent
{
public:
	...
	class UPaper2D_PaperTerrainSplineComponent*        AssociatedSpline;                                         // 0x03E8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	...
	TEnumAsByte<FPaper2D_Paper2D_ESpriteCollisionMode> SpriteCollisionDomain;                                    // 0x040C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UEngine_BodySetup*                           CachedBodySetup;                                          // 0x0418(0x0008) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
...
class UPaper2D_PaperTerrainMaterial : public UEngine_DataAsset
{
public:
	TArray<struct FPaper2D_PaperTerrainMaterialRule>   Rules;                                                    // 0x0030(0x0010) (Edit, ZeroConstructor)
	class UPaper2D_PaperSprite*                        InteriorFill;                                             // 0x0040(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
class UPaper2D_PaperTerrainSplineComponent : public UEngine_SplineComponent
{
public:
...
class UPaper2D_PaperTileLayer : public UObject
{
public:
	...
	TArray<struct FPaper2D_PaperTileInfo>              AllocatedCells;                                           // 0x0070(0x0010) (ZeroConstructor)
	class UPaper2D_PaperTileSet*                       TileSet;                                                  // 0x0080(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
...
// 0x0080 (0x00A8 - 0x0028)
class UPaper2D_PaperTileMap : public UObject
{
public:
	...
	class UEngine_MaterialInterface*                   Material;                                                 // 0x0070(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<class UPaper2D_PaperTileLayer*>             TileLayers;                                               // 0x0078(0x0010) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor)
	float                                              CollisionThickness;                                       // 0x0088(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<FPaper2D_Paper2D_ESpriteCollisionMode> SpriteCollisionDomain;                                    // 0x008C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<FPaper2D_Paper2D_ETileMapProjectionMode> ProjectionMode;                                           // 0x008D(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x4];                                       // 0x0094(0x0004) MISSED OFFSET
	class UEngine_BodySetup*                           BodySetup;                                                // 0x0098(0x0008) (ZeroConstructor, IsPlainOldData)
...
// 0x0008 (0x0220 - 0x0218)
class APaper2D_PaperTileMapActor : public AEngine_Actor
{
public:
	class UPaper2D_PaperTileMapComponent*              RenderComponent;                                          // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
// 0x0050 (0x0450 - 0x0400)
class UPaper2D_PaperTileMapComponent : public UEngine_MeshComponent
{
public:
	...
	class UPaper2D_PaperTileSet*                       DefaultLayerTileSet;                                      // 0x0410(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UEngine_MaterialInterface*                   Material;                                                 // 0x0418(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	TArray<class UPaper2D_PaperTileLayer*>             TileLayers;                                               // 0x0420(0x0010) (ZeroConstructor, Deprecated)
	...
	class UPaper2D_PaperTileMap*                       TileMap;                                                  // 0x0448(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	bool SetTileMap(class UPaper2D_PaperTileMap* NewTileMap);
	void SetTile(int X, int Y, int Layer, const struct FPaper2D_PaperTileInfo& NewValue);
	...
	struct FPaper2D_PaperTileInfo GetTile(int X, int Y, int Layer);
	...
	class UPaper2D_PaperTileLayer* AddNewLayer();
};


// Class Paper2D.PaperTileSet
// 0x0080 (0x00A8 - 0x0028)
class UPaper2D_PaperTileSet : public UObject
{
public:
	struct FIntPoint                                   TileSize;                                                 // 0x0028(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class UEngine_Texture2D*                           TileSheet;                                                // 0x0030(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	TArray<class UEngine_Texture*>                     AdditionalSourceTextures;                                 // 0x0038(0x0010) (Edit, ZeroConstructor)
	struct FPaper2D_IntMargin                          BorderMargin;                                             // 0x0048(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	TArray<struct FPaper2D_PaperTileMetadata>          PerTileData;                                              // 0x0078(0x0010) (Edit, EditFixedSize, ZeroConstructor)
	TArray<struct FPaper2D_PaperTileSetTerrain>        Terrains;                                                 // 0x0088(0x0010) (ZeroConstructor)
...
// 0x0000 (0x0028 - 0x0028)
class UPaper2D_TileMapBlueprintLibrary : public UEngine_BlueprintFunctionLibrary
{
public:
	...
	struct FPaper2D_PaperTileInfo STATIC_MakeTile(int TileIndex, class UPaper2D_PaperTileSet* TileSet, bool bFlipH, bool bFlipV, bool bFlipD);
	struct FName STATIC_GetTileUserData(const struct FPaper2D_PaperTileInfo& Tile);
	struct FTransform STATIC_GetTileTransform(const struct FPaper2D_PaperTileInfo& Tile);
	void STATIC_BreakTile(const struct FPaper2D_PaperTileInfo& Tile, int* TileIndex, class UPaper2D_PaperTileSet** TileSet, bool* bFlipH, bool* bFlipV, bool* bFlipD);
};
