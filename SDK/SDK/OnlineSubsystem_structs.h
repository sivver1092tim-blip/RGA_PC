...
enum class FOnlineSubsystem_OnlineSubsystem_EInAppPurchaseState : uint8_t
{
...
enum class FOnlineSubsystem_OnlineSubsystem_EMPMatchOutcome : uint8_t
{
...
// 0x0010
struct FOnlineSubsystem_NamedInterface
{
...
// 0x0018
struct FOnlineSubsystem_NamedInterfaceDef
{
	struct FName                                       InterfaceName;                                            // 0x0000(0x0008) (ZeroConstructor, IsPlainOldData)
...
// 0x00A8
struct FOnlineSubsystem_InAppPurchaseProductInfo
{
...
// 0x0030
struct FOnlineSubsystem_InAppPurchaseRestoreInfo
{
	struct FString                                     Identifier;                                               // 0x0000(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
...
// 0x0028
struct FOnlineSubsystem_InAppPurchaseProductRequest
{
	...
	struct FString                                     PurchaseIdentifier;                                       // 0x0018(0x0010) (BlueprintVisible, ZeroConstructor)
};
