...
class UBuildPatchServices_BuildPatchManifest : public UObject
{
public:
	...
	TArray<struct FBuildPatchServices_FileManifestData> FileManifestList;                                         // 0x00F0(0x0010) (ZeroConstructor)
	TArray<struct FBuildPatchServices_ChunkInfoData>   ChunkList;                                                // 0x0100(0x0010) (ZeroConstructor)
	TArray<struct FBuildPatchServices_CustomFieldData> CustomFields;                                             // 0x0110(0x0010) (ZeroConstructor)
