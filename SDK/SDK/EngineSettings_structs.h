...
enum class FEngineSettings_EngineSettings_ESubLevelStripMode : uint8_t
{
...
enum class FEngineSettings_EngineSettings_EFourPlayerSplitScreenType : uint8_t
{
...
enum class FEngineSettings_EngineSettings_EThreePlayerSplitScreenType : uint8_t
{
...
enum class FEngineSettings_EngineSettings_ETwoPlayerSplitScreenType : uint8_t
{
...
// 0x0028
struct FEngineSettings_AutoCompleteCommand
{
...
// 0x0028
struct FEngineSettings_GameModeName
{
