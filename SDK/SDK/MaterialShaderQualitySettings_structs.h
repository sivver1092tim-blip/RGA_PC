...
enum class FMaterialShaderQualitySettings_MaterialShaderQualitySettings_EMobileCSMQuality : uint8_t
{
...
// 0x0008
struct FMaterialShaderQualitySettings_MaterialQualityOverrides
{
	...
	FMaterialShaderQualitySettings_MaterialShaderQualitySettings_EMobileCSMQuality MobileCSMQuality;                                         // 0x0007(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
};
