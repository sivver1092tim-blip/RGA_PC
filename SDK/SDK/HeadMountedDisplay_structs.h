...
enum class FHeadMountedDisplay_HeadMountedDisplay_ESpectatorScreenMode : uint8_t
{
...
enum class FHeadMountedDisplay_HeadMountedDisplay_EHMDWornState : uint8_t
{
...
enum class FHeadMountedDisplay_HeadMountedDisplay_EHMDTrackingOrigin : uint8_t
{
...
enum class FHeadMountedDisplay_HeadMountedDisplay_EOrientPositionSelector : uint8_t
{
...
enum class FHeadMountedDisplay_HeadMountedDisplay_ETrackingStatus : uint8_t
{
...
enum class FHeadMountedDisplay_HeadMountedDisplay_EXRTrackedDeviceType : uint8_t
{
...
// 0x000C
struct FHeadMountedDisplay_XRDeviceId
{
