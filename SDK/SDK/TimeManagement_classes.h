...
class UTimeManagement_TimeSynchronizationSource : public UObject
{
public:
...
// 0x0008 (0x0030 - 0x0028)
class UTimeManagement_FixedFrameRateCustomTimeStep : public UEngine_EngineCustomTimeStep
{
public:
...
class UTimeManagement_TimeManagementBlueprintLibrary : public UEngine_BlueprintFunctionLibrary
{
public:
