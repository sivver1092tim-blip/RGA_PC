...
enum class FVectorVM_VectorVM_EVectorVMOp : uint8_t
{
	EVectorVMOp__done              = 0,
	EVectorVMOp__add               = 1,
	EVectorVMOp__sub               = 2,
...
enum class FVectorVM_VectorVM_EVectorVMOperandLocation : uint8_t
{
...
enum class FVectorVM_VectorVM_EVectorVMBaseTypes : uint8_t
{
