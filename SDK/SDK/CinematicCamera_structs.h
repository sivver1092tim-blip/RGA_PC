...
enum class FCinematicCamera_CinematicCamera_ECameraFocusMethod : uint8_t
{
...
// 0x0050
struct FCinematicCamera_CameraLookatTrackingSettings
{
...
// 0x000C
struct FCinematicCamera_CameraFilmbackSettings
{
...
// 0x0018
struct FCinematicCamera_CameraLensSettings
{
...
// 0x0038
struct FCinematicCamera_CameraTrackingFocusSettings
{
...
// 0x0058
struct FCinematicCamera_CameraFocusSettings
{
	FCinematicCamera_CinematicCamera_ECameraFocusMethod FocusMethod;                                              // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              ManualFocusDistance;                                      // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FCinematicCamera_CameraTrackingFocusSettings TrackingFocusSettings;                                    // 0x0008(0x0038) (Edit, BlueprintVisible)
...
// 0x0020
struct FCinematicCamera_NamedFilmbackPreset
{
	struct FString                                     Name;                                                     // 0x0000(0x0010) (ZeroConstructor)
	struct FCinematicCamera_CameraFilmbackSettings     FilmbackSettings;                                         // 0x0010(0x000C)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
};

// ScriptStruct CinematicCamera.NamedLensPreset
// 0x0028
struct FCinematicCamera_NamedLensPreset
{
	struct FString                                     Name;                                                     // 0x0000(0x0010) (BlueprintVisible, ZeroConstructor)
	struct FCinematicCamera_CameraLensSettings         LensSettings;                                             // 0x0010(0x0018) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
