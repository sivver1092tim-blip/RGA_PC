...
class ULightPropagationVolumeRuntime_LightPropagationVolumeBlendable : public UObject
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	struct FRenderer_LightPropagationVolumeSettings    Settings;                                                 // 0x0030(0x0040) (Edit, BlueprintVisible)
