...
enum class FMediaUtils_MediaUtils_EMediaPlayerOptionBooleanOverride : uint8_t
{
...
// 0x001C
struct FMediaUtils_MediaPlayerTrackOptions
{
...
// 0x0030
struct FMediaUtils_MediaPlayerOptions
{
	struct FMediaUtils_MediaPlayerTrackOptions         Tracks;                                                   // 0x0000(0x001C) (BlueprintVisible)
	unsigned char                                      UnknownData00[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FTimespan                                   SeekTime;                                                 // 0x0020(0x0008) (BlueprintVisible, ZeroConstructor)
	FMediaUtils_MediaUtils_EMediaPlayerOptionBooleanOverride PlayOnOpen;                                               // 0x0028(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	FMediaUtils_MediaUtils_EMediaPlayerOptionBooleanOverride Loop;                                                     // 0x0029(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
