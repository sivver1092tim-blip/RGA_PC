...
enum class FMagicLeapController_MagicLeapController_EMagicLeapTouchpadGestureDirection : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapTouchpadGestureType : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerTrackingMode : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerHapticIntensity : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerHapticPattern : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerLEDSpeed : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerLEDColor : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerLEDEffect : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerLEDPattern : uint8_t
{
...
enum class FMagicLeapController_MagicLeapController_EMagicLeapControllerType : uint8_t
{
...
// 0x0030
struct FMagicLeapController_MagicLeapTouchpadGesture
{
	FInputCore_InputCore_EControllerHand               Hand;                                                     // 0x0000(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	struct FName                                       MotionSource;                                             // 0x0004(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	FMagicLeapController_MagicLeapController_EMagicLeapTouchpadGestureType Type;                                                     // 0x000C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	FMagicLeapController_MagicLeapController_EMagicLeapTouchpadGestureDirection Direction;                                                // 0x000D(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
