...
enum class FAugmentedReality_AugmentedReality_EARTrackingState : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARSessionTrackingFeature : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARFaceTrackingUpdate : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EAREnvironmentCaptureProbeType : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARFrameSyncMode : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARLightEstimationMode : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARPlaneDetectionMode : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARSessionType : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARWorldAlignment : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARDepthAccuracy : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARDepthQuality : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARTextureType : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EAREye : uint8_t
{
	EAREye__LeftEye                = 0,
	EAREye__RightEye               = 1,
...
enum class FAugmentedReality_AugmentedReality_EARFaceBlendShape : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARFaceTrackingDirection : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARCandidateImageOrientation : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARJointTransformSpace : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARObjectClassification : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARPlaneOrientation : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARWorldMappingState : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARSessionStatus : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARTrackingQualityReason : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARTrackingQuality : uint8_t
{
...
enum class FAugmentedReality_AugmentedReality_EARLineTraceChannels : uint8_t
{
...
// 0x000C
struct FAugmentedReality_ARVideoFormat
{
...
// 0x0060
struct FAugmentedReality_ARTraceResult
{
	float                                              DistanceFromCamera;                                       // 0x0000(0x0004) (ZeroConstructor, IsPlainOldData)
	FAugmentedReality_AugmentedReality_EARLineTraceChannels TraceChannel;                                             // 0x0004(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	class UAugmentedReality_ARTrackedGeometry*         TrackedGeometry;                                          // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x0048(0x0018) MISSED OFFSET
};

// ScriptStruct AugmentedReality.ARSkeletonDefinition
// 0x0028
struct FAugmentedReality_ARSkeletonDefinition
{
...
// 0x0050
struct FAugmentedReality_ARPose3D
{
	struct FAugmentedReality_ARSkeletonDefinition      SkeletonDefinition;                                       // 0x0000(0x0028) (BlueprintVisible, BlueprintReadOnly)
	...
	FAugmentedReality_AugmentedReality_EARJointTransformSpace JointTransformSpace;                                      // 0x0048(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0049(0x0007) MISSED OFFSET
};

// ScriptStruct AugmentedReality.ARSessionStatus
// 0x0018
struct FAugmentedReality_ARSessionStatus
{
	struct FString                                     AdditionalInfo;                                           // 0x0000(0x0010) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor)
	FAugmentedReality_AugmentedReality_EARSessionStatus Status;                                                   // 0x0010(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0011(0x0007) MISSED OFFSET
};

// ScriptStruct AugmentedReality.ARPose2D
// 0x0048
struct FAugmentedReality_ARPose2D
{
	struct FAugmentedReality_ARSkeletonDefinition      SkeletonDefinition;                                       // 0x0000(0x0028) (BlueprintVisible, BlueprintReadOnly)
...
// 0x0008
struct FAugmentedReality_ARSharedWorldReplicationState
{
