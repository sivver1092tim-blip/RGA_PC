...
enum class FMediaAssets_MediaAssets_EMediaWebcamCaptureDeviceFilter : uint8_t
{
...
enum class FMediaAssets_MediaAssets_EMediaAudioCaptureDeviceFilter : uint8_t
{
...
enum class FMediaAssets_MediaAssets_EMediaPlayerTrack : uint8_t
{
...
enum class FMediaAssets_MediaAssets_EMediaSoundComponentFFTSize : uint8_t
{
...
enum class FMediaAssets_MediaAssets_EMediaSoundChannels : uint8_t
{
...
enum class FMediaAssets_MediaAssets_EMediaVideoCaptureDeviceFilter : uint8_t
{
...
// 0x0008
struct FMediaAssets_MediaSoundComponentSpectralData
{
...
// 0x0028
struct FMediaAssets_MediaCaptureDevice
{
