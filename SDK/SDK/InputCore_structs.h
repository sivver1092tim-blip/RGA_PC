...
enum class FInputCore_InputCore_ETouchIndex : uint8_t
{
...
enum class FInputCore_InputCore_EControllerHand : uint8_t
{
...
enum class FInputCore_InputCore_ETouchType : uint8_t
{
	ETouchType__Began              = 0,
	ETouchType__Moved              = 1,
...
enum class FInputCore_InputCore_EConsoleForGamepadLabels : uint8_t
{
