...
class UGeometryCollectionEngine_ChaosDestructionListener : public UEngine_SceneComponent
{
public:
	...
	struct FGeometryCollectionEngine_ChaosCollisionEventRequestSettings CollisionEventRequestSettings;                            // 0x01F4(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FGeometryCollectionEngine_ChaosBreakingEventRequestSettings BreakingEventRequestSettings;                             // 0x020C(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	struct FGeometryCollectionEngine_ChaosTrailingEventRequestSettings TrailingEventRequestSettings;                             // 0x0224(0x0018) (Edit, BlueprintVisible, BlueprintReadOnly)
	...
	void SortTrailingEvents(FGeometryCollectionEngine_GeometryCollectionEngine_EChaosTrailingSortMethod SortMethod, TArray<struct FGeometryCollectionEngine_ChaosTrailingEventData>* TrailingEvents);
	void SortCollisionEvents(FGeometryCollectionEngine_GeometryCollectionEngine_EChaosCollisionSortMethod SortMethod, TArray<struct FGeometryCollectionEngine_ChaosCollisionEventData>* CollisionEvents);
	void SortBreakingEvents(FGeometryCollectionEngine_GeometryCollectionEngine_EChaosBreakingSortMethod SortMethod, TArray<struct FGeometryCollectionEngine_ChaosBreakingEventData>* BreakingEvents);
	void SetTrailingEventRequestSettings(const struct FGeometryCollectionEngine_ChaosTrailingEventRequestSettings& InSettings);
	void SetTrailingEventEnabled(bool bIsEnabled);
	void SetCollisionEventRequestSettings(const struct FGeometryCollectionEngine_ChaosCollisionEventRequestSettings& InSettings);
	void SetCollisionEventEnabled(bool bIsEnabled);
	void SetBreakingEventRequestSettings(const struct FGeometryCollectionEngine_ChaosBreakingEventRequestSettings& InSettings);
	void SetBreakingEventEnabled(bool bIsEnabled);
	void RemoveGeometryCollectionActor(class AGeometryCollectionEngine_GeometryCollectionActor* GeometryCollectionActor);
	void RemoveChaosSolverActor(class AChaosSolverEngine_ChaosSolverActor* ChaosSolverActor);
	bool IsEventListening();
	void AddGeometryCollectionActor(class AGeometryCollectionEngine_GeometryCollectionActor* GeometryCollectionActor);
	void AddChaosSolverActor(class AChaosSolverEngine_ChaosSolverActor* ChaosSolverActor);
};


// Class GeometryCollectionEngine.GeometryCollectionActor
// 0x0010 (0x0228 - 0x0218)
class AGeometryCollectionEngine_GeometryCollectionActor : public AEngine_Actor
{
public:
	class UGeometryCollectionEngine_GeometryCollectionComponent* GeometryCollectionComponent;                              // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	class UGeometryCollectionEngine_GeometryCollectionDebugDrawComponent* GeometryCollectionDebugDrawComponent;                     // 0x0220(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	...
	bool RaycastSingle(const struct FVector& Start, const struct FVector& End, struct FEngine_HitResult* OutHit);
};


// Class GeometryCollectionEngine.GeometryCollectionComponent
// 0x03F0 (0x07F0 - 0x0400)
class UGeometryCollectionEngine_GeometryCollectionComponent : public UEngine_MeshComponent
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0400(0x0008) MISSED OFFSET
	class AChaosSolverEngine_ChaosSolverActor*         ChaosSolverActor;                                         // 0x0408(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xE0];                                      // 0x0410(0x00E0) MISSED OFFSET
	class UGeometryCollectionEngine_GeometryCollection* RestCollection;                                           // 0x04F0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear, IsPlainOldData)
	TArray<class AFieldSystemEngine_FieldSystemActor*> InitializationFields;                                     // 0x04F8(0x0010) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, NoClear)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EObjectStateTypeEnum ObjectType;                                               // 0x0510(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	FChaosSolverEngine_ChaosSolverEngine_EClusterConnectionTypeEnum ClusterConnectionType;                                    // 0x0530(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UEngine_ChaosPhysicalMaterial*               PhysicalMaterial;                                         // 0x0540(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EInitialVelocityTypeEnum InitialVelocityType;                                      // 0x0548(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FGeometryCollectionEngine_GeomComponentCacheParameters CacheParameters;                                          // 0x0568(0x0050) (Edit)
	...
	class UEngine_BodySetup*                           DummyBodySetup;                                           // 0x07C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	void ReceivePhysicsCollision(const struct FChaosSolverEngine_ChaosPhysicsCollisionInfo& CollisionInfo);
	void NotifyGeometryCollectionPhysicsStateChange__DelegateSignature(class UGeometryCollectionEngine_GeometryCollectionComponent* FracturedComponent);
	void NotifyGeometryCollectionPhysicsLoadingStateChange__DelegateSignature(class UGeometryCollectionEngine_GeometryCollectionComponent* FracturedComponent);
	void ApplyPhysicsField(bool Enabled, FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EGeometryCollectionPhysicsTypeEnum Target, class UFieldSystemEngine_FieldSystemMetaData* MetaData, class UFieldSystemEngine_FieldNodeBase* Field);
...
class AGeometryCollectionEngine_GeometryCollectionDebugDrawActor : public AEngine_Actor
{
public:
	struct FGeometryCollectionEngine_GeometryCollectionDebugDrawWarningMessage WarningMessage;                                           // 0x0218(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0219(0x0007) MISSED OFFSET
	struct FGeometryCollectionEngine_GeometryCollectionDebugDrawActorSelectedRigidBody SelectedRigidBody;                                        // 0x0220(0x0018) (Edit)
	...
	FGeometryCollectionEngine_GeometryCollectionEngine_EGeometryCollectionDebugDrawActorHideGeometry HideGeometry;                                             // 0x023B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	class UEngine_BillboardComponent*                  SpriteComponent;                                          // 0x02D0(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
class UGeometryCollectionEngine_GeometryCollectionDebugDrawComponent : public UEngine_ActorComponent
{
public:
	class AGeometryCollectionEngine_GeometryCollectionDebugDrawActor* GeometryCollectionDebugDrawActor;                         // 0x00B0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class AGeometryCollectionEngine_GeometryCollectionRenderLevelSetActor* GeometryCollectionRenderLevelSetActor;                    // 0x00B8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
...
class UGeometryCollectionEngine_GeometryCollection : public UObject
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	TArray<class UEngine_MaterialInterface*>           Materials;                                                // 0x0030(0x0010) (Edit, ZeroConstructor)
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_ECollisionTypeEnum CollisionType;                                            // 0x0040(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EImplicitTypeEnum ImplicitType;                                             // 0x0041(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	TArray<struct FGeometryCollectionEngine_GeometryCollectionSizeSpecificData> SizeSpecificData;                                         // 0x0070(0x0010) (Edit, ZeroConstructor)
	...
	TArray<class UEngine_MaterialInterface*>           RemoveOnFractureMaterials;                                // 0x0088(0x0010) (Edit, ZeroConstructor)
...
class AGeometryCollectionEngine_GeometryCollectionRenderLevelSetActor : public AEngine_Actor
{
public:
	class UEngine_VolumeTexture*                       TargetVolumeTexture;                                      // 0x0218(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UEngine_Material*                            RayMarchMaterial;                                         // 0x0220(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
class UGeometryCollectionEngine_SkeletalMeshSimulationComponent : public UEngine_ActorComponent
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00B0(0x0008) MISSED OFFSET
	class UEngine_ChaosPhysicalMaterial*               PhysicalMaterial;                                         // 0x00B8(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AChaosSolverEngine_ChaosSolverActor*         ChaosSolverActor;                                         // 0x00C0(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EObjectStateTypeEnum ObjectType;                                               // 0x00D2(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_ECollisionTypeEnum CollisionType;                                            // 0x00E0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EInitialVelocityTypeEnum InitialVelocityType;                                      // 0x00FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
// 0x0088 (0x0138 - 0x00B0)
class UGeometryCollectionEngine_StaticMeshSimulationComponent : public UEngine_ActorComponent
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x00B0(0x0008) MISSED OFFSET
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EObjectStateTypeEnum ObjectType;                                               // 0x00BA(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_ECollisionTypeEnum CollisionType;                                            // 0x00C0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EImplicitTypeEnum ImplicitType;                                             // 0x00C1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	FGeometryCollectionSimulationCore_GeometryCollectionSimulationCore_EInitialVelocityTypeEnum InitialVelocityType;                                      // 0x00CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class UEngine_ChaosPhysicalMaterial*               PhysicalMaterial;                                         // 0x00F0(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	class AChaosSolverEngine_ChaosSolverActor*         ChaosSolverActor;                                         // 0x00F8(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	...
	TArray<class UEngine_PrimitiveComponent*>          SimulatedComponents;                                      // 0x0120(0x0010) (ExportObject, ZeroConstructor)
...
class UGeometryCollectionEngine_GeometryCollectionCache : public UObject
{
public:
	struct FGeometryCollectionCore_RecordedTransformTrack RecordedData;                                             // 0x0028(0x0010)
	class UGeometryCollectionEngine_GeometryCollection* SupportedCollection;                                      // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
