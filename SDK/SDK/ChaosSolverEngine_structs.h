...
enum class FChaosSolverEngine_ChaosSolverEngine_EClusterConnectionTypeEnum : uint8_t
{
...
// 0x0058
struct FChaosSolverEngine_ChaosHandlerSet
{
...
// 0x0040
struct FChaosSolverEngine_BreakEventCallbackWrapper
{
...
// 0x0070
struct FChaosSolverEngine_ChaosPhysicsCollisionInfo
{
	class UEngine_PrimitiveComponent*                  Component;                                                // 0x0000(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UEngine_PrimitiveComponent*                  OtherComponent;                                           // 0x0008(0x0008) (Edit, BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
// 0x0003
struct FChaosSolverEngine_ChaosDebugSubstepControl
{
...
// 0x0030
struct FChaosSolverEngine_ChaosBreakEvent
{
	class UEngine_PrimitiveComponent*                  Component;                                                // 0x0000(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
