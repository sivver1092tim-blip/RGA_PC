...
enum class FGameplayTasks_GameplayTasks_ETaskResourceOverlapPolicy : uint8_t
{
...
enum class FGameplayTasks_GameplayTasks_EGameplayTaskState : uint8_t
{
...
enum class FGameplayTasks_GameplayTasks_EGameplayTaskRunResult : uint8_t
{
...
// 0x0002
struct FGameplayTasks_GameplayResourceSet
{
