...
// 0x0030
struct FSerialization_StructSerializerNumericTestStruct
{
...
// 0x0003
struct FSerialization_StructSerializerBooleanTestStruct
{
...
// 0x00A0
struct FSerialization_StructSerializerObjectTestStruct
{
...
// 0x0090
struct FSerialization_StructSerializerBuiltinTestStruct
{
...
// 0x0050
struct FSerialization_StructSerializerArrayTestStruct
{
	...
	TArray<struct FSerialization_StructSerializerBuiltinTestStruct> StructArray;                                              // 0x0040(0x0010) (ZeroConstructor)
};

// ScriptStruct Serialization.StructSerializerMapTestStruct
// 0x0140
struct FSerialization_StructSerializerMapTestStruct
{
	...
	TMap<struct FString, struct FSerialization_StructSerializerBuiltinTestStruct> StrToStruct;                                              // 0x00F0(0x0050) (ZeroConstructor)
};

// ScriptStruct Serialization.StructSerializerSetTestStruct
// 0x0140
struct FSerialization_StructSerializerSetTestStruct
{
...
// 0x0440
struct FSerialization_StructSerializerTestStruct
{
	struct FSerialization_StructSerializerNumericTestStruct Numerics;                                                 // 0x0000(0x0030)
	struct FSerialization_StructSerializerBooleanTestStruct Booleans;                                                 // 0x0030(0x0003)
	unsigned char                                      UnknownData00[0x5];                                       // 0x0033(0x0005) MISSED OFFSET
	struct FSerialization_StructSerializerObjectTestStruct Objects;                                                  // 0x0038(0x00A0)
	unsigned char                                      UnknownData01[0x8];                                       // 0x00D8(0x0008) MISSED OFFSET
	struct FSerialization_StructSerializerBuiltinTestStruct Builtins;                                                 // 0x00E0(0x0090)
	struct FSerialization_StructSerializerArrayTestStruct Arrays;                                                   // 0x0170(0x0050)
	struct FSerialization_StructSerializerMapTestStruct Maps;                                                     // 0x01C0(0x0140)
	struct FSerialization_StructSerializerSetTestStruct Sets;                                                     // 0x0300(0x0140)
};
