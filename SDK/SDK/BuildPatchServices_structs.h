...
// 0x0014
struct FBuildPatchServices_SHAHashData
{
...
// 0x0018
struct FBuildPatchServices_ChunkPartData
{
...
// 0x0068
struct FBuildPatchServices_FileManifestData
{
	struct FString                                     Filename;                                                 // 0x0000(0x0010) (ZeroConstructor)
	struct FBuildPatchServices_SHAHashData             FileHash;                                                 // 0x0010(0x0014)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0024(0x0004) MISSED OFFSET
	TArray<struct FBuildPatchServices_ChunkPartData>   FileChunkParts;                                           // 0x0028(0x0010) (ZeroConstructor)
...
// 0x0040
struct FBuildPatchServices_ChunkInfoData
{
	struct FGuid                                       Guid;                                                     // 0x0000(0x0010) (ZeroConstructor, IsPlainOldData)
	uint64_t                                           Hash;                                                     // 0x0010(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FBuildPatchServices_SHAHashData             ShaHash;                                                  // 0x0018(0x0014)
...
// 0x0020
struct FBuildPatchServices_CustomFieldData
{
