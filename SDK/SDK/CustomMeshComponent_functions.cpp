...
// Parameters:
// TArray<struct FCustomMeshComponent_CustomMeshTriangle> Triangles                      (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// bool                           ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

bool UCustomMeshComponent_CustomMeshComponent::SetCustomMeshTriangles(TArray<struct FCustomMeshComponent_CustomMeshTriangle> Triangles)
{
	...
	UCustomMeshComponent_CustomMeshComponent_SetCustomMeshTriangles_Params params;
...
void UCustomMeshComponent_CustomMeshComponent::ClearCustomMeshTriangles()
{
	...
	UCustomMeshComponent_CustomMeshComponent_ClearCustomMeshTriangles_Params params;
...
void UCustomMeshComponent_CustomMeshComponent::AddCustomMeshTriangles(TArray<struct FCustomMeshComponent_CustomMeshTriangle> Triangles)
{
	...
	UCustomMeshComponent_CustomMeshComponent_AddCustomMeshTriangles_Params params;
	params.Triangles = Triangles;
