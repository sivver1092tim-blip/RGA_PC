...
enum class FAppleImageUtils_AppleImageUtils_EAppleTextureType : uint8_t
{
...
enum class FAppleImageUtils_AppleImageUtils_ETextureRotationDirection : uint8_t
{
...
// 0x0020
struct FAppleImageUtils_AppleImageUtilsImageConversionResult
{
