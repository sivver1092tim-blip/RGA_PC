...
class UClothingSystemRuntimeInterface_ClothConfigBase : public UObject
{
public:
...
class UClothingSystemRuntimeInterface_ClothingAssetBase : public UObject
{
public:
...
// 0x0000 (0x0028 - 0x0028)
class UClothingSystemRuntimeInterface_ClothingSimulationFactory : public UObject
{
public:
...
class UClothingSystemRuntimeInterface_ClothingSimulationInteractor : public UObject
{
public:
...
class UClothingSystemRuntimeInterface_ClothPhysicalMeshDataBase : public UObject
{
public:
	...
	TArray<struct FClothingSystemRuntimeInterface_ClothVertBoneData> BoneData;                                                 // 0x0068(0x0010) (Edit, ZeroConstructor)
	...
	static UClass* StaticClass()
	{
		...
		if (!ptr)
			ptr = UObject::FindClass("Class ClothingSystemRuntimeInterface.ClothPhysicalMeshDataBase");
		return ptr;
	}
