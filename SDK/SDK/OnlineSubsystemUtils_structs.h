...
enum class FOnlineSubsystemUtils_OnlineSubsystemUtils_EBeaconConnectionState : uint8_t
{
...
enum class FOnlineSubsystemUtils_OnlineSubsystemUtils_EPartyReservationResult : uint8_t
{
...
enum class FOnlineSubsystemUtils_OnlineSubsystemUtils_ESpectatorClientRequestType : uint8_t
{
...
enum class FOnlineSubsystemUtils_OnlineSubsystemUtils_EClientRequestType : uint8_t
{
...
enum class FOnlineSubsystemUtils_OnlineSubsystemUtils_ESpectatorReservationResult : uint8_t
{
...
// 0x00B8
struct FOnlineSubsystemUtils_BlueprintSessionResult
{
...
// 0x0040
struct FOnlineSubsystemUtils_PIELoginSettingsInternal
{
...
// 0x0050
struct FOnlineSubsystemUtils_PlayerReservation
{
	struct FEngine_UniqueNetIdRepl                     UniqueId;                                                 // 0x0000(0x0028) (Transient)
...
// 0x0050
struct FOnlineSubsystemUtils_PartyReservation
{
	int                                                TeamNum;                                                  // 0x0000(0x0004) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0004(0x0004) MISSED OFFSET
	struct FEngine_UniqueNetIdRepl                     PartyLeader;                                              // 0x0008(0x0028) (Transient)
	TArray<struct FOnlineSubsystemUtils_PlayerReservation> PartyMembers;                                             // 0x0030(0x0010) (ZeroConstructor, Transient)
	TArray<struct FOnlineSubsystemUtils_PlayerReservation> RemovedPartyMembers;                                      // 0x0040(0x0010) (ZeroConstructor, Transient)
};

// ScriptStruct OnlineSubsystemUtils.SpectatorReservation
// 0x0078
struct FOnlineSubsystemUtils_SpectatorReservation
{
	struct FEngine_UniqueNetIdRepl                     SpectatorId;                                              // 0x0000(0x0028) (Transient)
	struct FOnlineSubsystemUtils_PlayerReservation     Spectator;                                                // 0x0028(0x0050) (Transient)
};
