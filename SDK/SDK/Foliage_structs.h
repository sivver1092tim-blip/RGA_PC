...
enum class FFoliage_Foliage_EFoliageScaling : uint8_t
{
...
enum class FFoliage_Foliage_EVertexColorMaskChannel : uint8_t
{
...
enum class FFoliage_Foliage_EFoliageVertexColorMask : uint8_t
{
...
enum class FFoliage_Foliage_ESimulationQuery : uint8_t
{
...
enum class FFoliage_Foliage_ESimulationOverlap : uint8_t
{
...
// 0x000C
struct FFoliage_FoliageVertexColorChannelMask
{
...
// 0x0020
struct FFoliage_FoliageTypeObject
{
	class UObject*                                     FoliageTypeObject;                                        // 0x0000(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	class UFoliage_FoliageType*                        TypeInstance;                                             // 0x0008(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
// 0x0060
struct FFoliage_ProceduralFoliageInstance
{
	...
	class UFoliage_FoliageType*                        Type;                                                     // 0x0038(0x0008) (ZeroConstructor, IsPlainOldData)
