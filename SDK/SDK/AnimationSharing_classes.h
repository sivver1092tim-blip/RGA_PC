...
class UAnimationSharing_AnimSharingStateInstance : public UEngine_AnimInstance
{
public:
	...
	class UAnimationSharing_AnimSharingInstance*       Instance;                                                 // 0x0280(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	...
	void GetInstancedActors(TArray<class AEngine_Actor*>* Actors);
};


// Class AnimationSharing.AnimSharingTransitionInstance
// 0x0010 (0x0280 - 0x0270)
class UAnimationSharing_AnimSharingTransitionInstance : public UEngine_AnimInstance
{
public:
	TWeakObjectPtr<class UEngine_SkeletalMeshComponent> ToComponent;                                              // 0x0270(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, InstancedReference, IsPlainOldData)
...
// 0x0010 (0x0280 - 0x0270)
class UAnimationSharing_AnimSharingAdditiveInstance : public UEngine_AnimInstance
{
public:
	TWeakObjectPtr<class UEngine_AnimSequence>         AdditiveAnimation;                                        // 0x0270(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
...
class UAnimationSharing_AnimSharingInstance : public UObject
{
public:
	TArray<class AEngine_Actor*>                       RegisteredActors;                                         // 0x0028(0x0010) (Edit, ZeroConstructor, Transient, EditConst)
	unsigned char                                      UnknownData00[0x70];                                      // 0x0038(0x0070) MISSED OFFSET
	class UAnimationSharing_AnimationSharingStateProcessor* StateProcessor;                                           // 0x00A8(0x0008) (Edit, ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData01[0x38];                                      // 0x00B0(0x0038) MISSED OFFSET
	TArray<class UEngine_AnimSequence*>                UsedAnimationSequences;                                   // 0x00E8(0x0010) (Edit, ZeroConstructor, Transient, EditConst)
	...
	class AEngine_Actor*                               SharingActor;                                             // 0x0110(0x0008) (Edit, ZeroConstructor, Transient, EditConst, IsPlainOldData)
...
class UAnimationSharing_AnimationSharingManager : public UObject
{
public:
	TArray<class UEngine_Skeleton*>                    Skeletons;                                                // 0x0028(0x0010) (ZeroConstructor, Transient)
	TArray<class UAnimationSharing_AnimSharingInstance*> PerSkeletonData;                                          // 0x0038(0x0010) (Edit, ZeroConstructor, Transient, EditConst)
	...
	void RegisterActorWithSkeletonBP(class AEngine_Actor* InActor, class UEngine_Skeleton* SharingSkeleton);
	class UAnimationSharing_AnimationSharingManager* STATIC_GetAnimationSharingManager(class UObject* WorldContextObject);
	bool STATIC_CreateAnimationSharingManager(class UObject* WorldContextObject, class UAnimationSharing_AnimationSharingSetup* Setup);
...
class UAnimationSharing_AnimationSharingSetup : public UObject
{
public:
	TArray<struct FAnimationSharing_PerSkeletonAnimationSharingSetup> SkeletonSetups;                                           // 0x0028(0x0010) (Edit, ZeroConstructor, Config)
	struct FAnimationSharing_AnimationSharingScalability ScalabilitySettings;                                      // 0x0038(0x0010) (Edit, Config)
...
class UAnimationSharing_AnimationSharingStateProcessor : public UObject
{
public:
	...
	void ProcessActorState(class AEngine_Actor* InActor, unsigned char currentState, unsigned char OnDemandState, int* OutState, bool* bShouldProcess);
