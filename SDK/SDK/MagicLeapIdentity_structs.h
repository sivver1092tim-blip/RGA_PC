...
enum class FMagicLeapIdentity_MagicLeapIdentity_EMagicLeapIdentityKey : uint8_t
{
...
enum class FMagicLeapIdentity_MagicLeapIdentity_EMagicLeapIdentityError : uint8_t
{
...
// 0x0018
struct FMagicLeapIdentity_MagicLeapIdentityAttribute
{
	FMagicLeapIdentity_MagicLeapIdentity_EMagicLeapIdentityKey Attribute;                                                // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
