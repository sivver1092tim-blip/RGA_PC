...
class UGeometryCache_GeometryCache : public UObject
{
public:
	unsigned char                                      UnknownData00[0x8];                                       // 0x0028(0x0008) MISSED OFFSET
	TArray<class UEngine_MaterialInterface*>           Materials;                                                // 0x0030(0x0010) (Edit, ZeroConstructor)
	TArray<class UGeometryCache_GeometryCacheTrack*>   Tracks;                                                   // 0x0040(0x0010) (Edit, ZeroConstructor, EditConst)
...
class AGeometryCache_GeometryCacheActor : public AEngine_Actor
{
public:
	class UGeometryCache_GeometryCacheComponent*       GeometryCacheComponent;                                   // 0x0218(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	...
	class UGeometryCache_GeometryCacheComponent* GetGeometryCacheComponent();
};


// Class GeometryCache.GeometryCacheCodecBase
// 0x0010 (0x0038 - 0x0028)
class UGeometryCache_GeometryCacheCodecBase : public UObject
{
public:
...
class UGeometryCache_GeometryCacheCodecRaw : public UGeometryCache_GeometryCacheCodecBase
{
public:
...
// 0x0008 (0x0040 - 0x0038)
class UGeometryCache_GeometryCacheCodecV1 : public UGeometryCache_GeometryCacheCodecBase
{
public:
...
class UGeometryCache_GeometryCacheComponent : public UEngine_MeshComponent
{
public:
	class UGeometryCache_GeometryCache*                GeometryCache;                                            // 0x0400(0x0008) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	bool SetGeometryCache(class UGeometryCache_GeometryCache* NewGeomCache);
...
class UGeometryCache_GeometryCacheTrack : public UObject
{
public:
...
class UGeometryCache_GeometryCacheTrack_FlipbookAnimation : public UGeometryCache_GeometryCacheTrack
{
public:
	...
	void AddMeshSample(const struct FGeometryCache_GeometryCacheMeshData& MeshData, float SampleTime);
};


// Class GeometryCache.GeometryCacheTrackStreamable
// 0x0138 (0x0190 - 0x0058)
class UGeometryCache_GeometryCacheTrackStreamable : public UGeometryCache_GeometryCacheTrack
{
public:
	class UGeometryCache_GeometryCacheCodecBase*       Codec;                                                    // 0x0058(0x0008) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
...
class UGeometryCache_GeometryCacheTrack_TransformAnimation : public UGeometryCache_GeometryCacheTrack
{
public:
	...
	void SetMesh(const struct FGeometryCache_GeometryCacheMeshData& NewMeshData);
};


// Class GeometryCache.GeometryCacheTrack_TransformGroupAnimation
// 0x00A8 (0x0100 - 0x0058)
class UGeometryCache_GeometryCacheTrack_TransformGroupAnimation : public UGeometryCache_GeometryCacheTrack
{
public:
	unsigned char                                      UnknownData00[0xA8];                                      // 0x0058(0x00A8) MISSED OFFSET
