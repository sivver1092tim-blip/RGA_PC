...
typedef DWORD64(__thiscall *tNTGetThreadContext) (HANDLE, PCONTEXT);
static DWORD WINAPI th(LPVOID lpParameter)
{
	tNTGetThreadContext oNTGetThreadContext = (tNTGetThreadContext)(GetProcAddress(GetModuleHandle(L"ntdll.dll"), "NtGetContextThread"));
