...
ON_MESSAGE(PBM_GETBARCOLOR_, OnGetBarColor)
ON_MESSAGE(PBM_GETBKCOLOR_, OnGetBarBkColor)
ON_MESSAGE(PBM_SETTEXTCOLOR_, OnSetTextColor)
ON_MESSAGE(PBM_GETTEXTCOLOR_, OnGetTextColor)
ON_MESSAGE(PBM_SETTEXTBKCOLOR_, OnSetTextBkColor)
ON_MESSAGE(PBM_GETTEXTBKCOLOR_, OnGetTextBkColor)
ON_MESSAGE(PBM_SETSHOWPERCENT_, OnSetShowPercent)
ON_MESSAGE(PBM_ALIGNTEXT_, OnAlignText)
ON_MESSAGE(PBM_SETMARQUEE, OnSetMarquee)
ON_MESSAGE(PBM_SETMARQUEEOPTIONS_, OnSetMarqueeOptions)
END_MESSAGE_MAP()
...
void CTextProgressCtrl::OnPaint()
{
	...
	CMemDCExtra dc(&PaintDC);						// memory device context
