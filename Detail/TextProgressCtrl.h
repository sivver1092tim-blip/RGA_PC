...
//		call	GetBarColor()
//		or		SendMessage (PBM_GETBARCOLOR_, 0, 0)
//		or		::SendMessage (m_hwnd, PBM_GETBARCOLOR_, 0, 0)
//
...
//		or		SendMessage (PBM_SETTEXTCOLOR_, 0, (LPARAM)crTextClr)
//		or		::SendMessage (m_hwnd, PBM_SETTEXTCOLOR_, 0, (LPARAM)crTextClr)

// To get the text color:
//		call	GetTextColor()
//		or		SendMessage (PBM_GETTEXTCOLOR_, 0, 0)
//		or		::SendMessage (m_hwnd, PBM_GETTEXTCOLOR_, 0, 0)
//
// To set the text background color:
//		call	SetTextBkColor(COLORREF crTextBkClr)
//		or		SendMessage (PBM_SETTEXTBKCOLOR_, 0, (LPARAM)crTextBkClr)
//		or		::SendMessage (m_hwnd, PBM_SETTEXTBKCOLOR_, 0, (LPARAM)crTextBkClr)
//
// To get the text background color:
//		call	GetTextBkColor()
//		or		SendMessage (PBM_GETTEXTBKCOLOR_, 0, 0)
//		or		::SendMessage (m_hwnd, PBM_GETTEXTBKCOLOR_, 0, 0)
//
// To show or hide percentage complete:
//		call	SetShowPercent(BOOL bShow)
//		or		SendMessage(PBM_SETSHOWPERCENT_, (WPARAM)bShow, 0)
//		or		::SendMessage(m_hWnd, PBM_SETSHOWPERCENT_, (WPARAM)bShow, 0)
//
// To set the text alignment mode:
//		call	AlignText(DWORD dwAlignment), where dwAlignment = DT_LEFT, DT_RIGHT or DT_CENTER
//		or		SendMessage(PBM_ALIGNTEXT_, (WPARAM)dwAlignment, 0)
//		or		SendMessage(m_hWnd, PBM_ALIGNTEXT_, (WPARAM)dwAlignment, 0)
//
...
//		or		SendMessage(PBM_SETMARQUEEOPTIONS_, (WPARAM)nBarSize, 0)
//		or		::SendMessage(m_hWnd, PBM_SETMARQUEEOPTIONS_, (WPARAM)nBarSize, 0)
//
////////////////////////////////////////////////////////////////////////////////
...
#define PBM_GETBARCOLOR_		(WM_USER+100)
#define PBM_GETBKCOLOR_			(WM_USER+101)
#define PBM_SETTEXTCOLOR_		(WM_USER+102)
#define PBM_GETTEXTCOLOR_		(WM_USER+103)
#define PBM_SETTEXTBKCOLOR_		(WM_USER+104)
#define PBM_GETTEXTBKCOLOR_		(WM_USER+105)
#define PBM_SETSHOWPERCENT_		(WM_USER+106)
#define PBM_ALIGNTEXT_			(WM_USER+107)
#define PBM_SETMARQUEEOPTIONS_	(WM_USER+108)
...
class CTextProgressCtrl : public CProgressCtrl
{
	...
	public:
		...
		inline COLORREF GetBarColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETBARCOLOR_, 0, 0)); }
		...
		inline COLORREF GetBarBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETBKCOLOR_, 0, 0)); }
		inline COLORREF SetTextColor(COLORREF crTextClr = CLR_DEFAULT)
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_SETTEXTCOLOR_, 0, (LPARAM)crTextClr)); }
		inline COLORREF GetTextColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETTEXTCOLOR_, 0, 0)); }
		inline COLORREF SetTextBkColor(COLORREF crTextBkClr = CLR_DEFAULT)
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_SETTEXTBKCOLOR_, 0, (LPARAM)crTextBkClr)); }
		inline COLORREF GetTextBkColor() const
			{ ASSERT(::IsWindow(m_hWnd)); return ((COLORREF) ::SendMessage(m_hWnd, PBM_GETTEXTBKCOLOR_, 0, 0)); }
		inline BOOL SetShowPercent(BOOL bShow)
			{ ASSERT(::IsWindow(m_hWnd)); return ((BOOL) ::SendMessage(m_hWnd, PBM_SETSHOWPERCENT_, (WPARAM)bShow, 0)); }
		inline DWORD AlignText(DWORD dwAlignment = DT_CENTER)
			{ ASSERT(::IsWindow(m_hWnd)); return ((DWORD) ::SendMessage(m_hWnd, PBM_ALIGNTEXT_, (WPARAM)dwAlignment, 0)); }
		...
		inline int SetMarqueeOptions(int nBarSize)
			{ ASSERT(::IsWindow(m_hWnd)); return ((BOOL) ::SendMessage(m_hWnd, PBM_SETMARQUEEOPTIONS_, (WPARAM)nBarSize, 0)); }
