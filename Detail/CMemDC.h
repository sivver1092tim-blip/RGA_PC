...
public:
	...
	CMemDCExtra(CDC* pDC, const CRect* pRect = NULL) : CDC()
	{
	...
	CMemDCExtra* operator->() { return this; }

	// allow usage as a pointer
	operator CMemDCExtra*() { return this; }
};
